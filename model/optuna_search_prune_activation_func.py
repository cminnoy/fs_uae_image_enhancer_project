...
def measure_performance(model: nn.Module, device: torch.device, input_size: Tuple[int, int, int, int] = (1, 3, 576, 752), warmup_iterations: int = 20, measure_duration: int = 20) -> float:
    ...
    try:
        ...
        # Warm-up
        print("Starting performance test warm-up...")
        if device.type == 'cuda':
...
def objective(trial: optuna.Trial) -> float:
  ...
  # params_for_perf_key['layer1_kernel_size'] = trial.suggest_categorical('layer1_kernel_size', [3, 5])
    params_for_perf_key['layer1_act1'] = trial.suggest_categorical('layer1_act1', ['identity', 'tanh', 'telu', 'gelu', 'sigmoid', 'sinlu', 'elu', 'mish', 'silu'])
    params_for_perf_key['layer1_act2'] = trial.suggest_categorical('layer1_act2', ['identity', 'relu', 'leaky_relu', 'biased_relu', 'prelu', 'relu6'])
  ...
  # params_for_perf_key['layer2_kernel_size'] = trial.suggest_categorical('layer2_kernel_size', [3, 5])
    params_for_perf_key['layer2_act1'] = trial.suggest_categorical('layer2_act1', ['identity', 'tanh', 'telu', 'gelu', 'sigmoid', 'sinlu', 'elu', 'mish', 'silu'])
    params_for_perf_key['layer2_act2'] = trial.suggest_categorical('layer2_act2', ['identity', 'relu', 'leaky_relu', 'biased_relu', 'prelu', 'relu6'])
    params_for_perf_key['layer2_act3'] = trial.suggest_categorical('layer2_act3', ['identity', 'tanh', 'telu', 'gelu', 'sigmoid', 'sinlu', 'elu', 'mish', 'silu'])
    params_for_perf_key['layer2_act4'] = trial.suggest_categorical('layer2_act4', ['identity', 'relu', 'leaky_relu', 'biased_relu', 'prelu', 'relu6'])

    # Layer 3
 #  params_for_perf_key['layer3_out_channels'] = trial.suggest_int('layer3_out_channels', 36, 72, step=2)
 #  params_for_perf_key['layer3_kernel_size'] = trial.suggest_categorical('layer3_kernel_size', [3, 5])
    params_for_perf_key['layer3_act1'] = trial.suggest_categorical('layer3_act1', ['identity', 'tanh', 'telu', 'gelu', 'sigmoid', 'sinlu', 'elu', 'mish', 'silu'])
    params_for_perf_key['layer3_act2'] = trial.suggest_categorical('layer3_act2', ['identity', 'relu', 'leaky_relu', 'biased_relu', 'prelu', 'relu6'])
  ...
  #  params_for_perf_key['layer4_kernel_size'] = trial.suggest_categorical('layer4_kernel_size', [3, 5])
    params_for_perf_key['layer4_act1'] = trial.suggest_categorical('layer4_act1', ['identity', 'tanh', 'telu', 'gelu', 'sigmoid', 'sinlu', 'elu', 'mish', 'silu'])
    params_for_perf_key['layer4_act2'] = trial.suggest_categorical('layer4_act2', ['identity', 'relu', 'leaky_relu', 'biased_relu', 'prelu', 'relu6'])
    params_for_perf_key['layer4_act3'] = trial.suggest_categorical('layer4_act3', ['identity', 'tanh', 'telu', 'gelu', 'sigmoid', 'sinlu', 'elu', 'mish', 'silu'])
    params_for_perf_key['layer4_act4'] = trial.suggest_categorical('layer4_act4', ['identity', 'relu', 'leaky_relu', 'biased_relu', 'prelu', 'relu6'])

    # Layer 5
  # params_for_perf_key['layer5_out_channels'] = trial.suggest_int('layer5_out_channels', 36, 72, step=2)
  # params_for_perf_key['layer5_kernel_size'] = trial.suggest_categorical('layer5_kernel_size', [3, 5])
    params_for_perf_key['layer5_act1'] = trial.suggest_categorical('layer5_act1', ['identity', 'tanh', 'telu', 'gelu', 'sigmoid', 'sinlu', 'elu', 'mish', 'silu'])
    params_for_perf_key['layer5_act2'] = trial.suggest_categorical('layer5_act2', ['identity', 'relu', 'leaky_relu', 'biased_relu', 'prelu', 'relu6'])
  ...
  # params_for_perf_key['layer6_kernel_size'] = trial.suggest_categorical('layer6_kernel_size', [3, 5])
    params_for_perf_key['layer6_act1'] = trial.suggest_categorical('layer6_act1', ['identity', 'tanh', 'telu', 'gelu', 'sigmoid', 'sinlu', 'elu', 'mish', 'silu'])
    params_for_perf_key['layer6_act2'] = trial.suggest_categorical('layer6_act2', ['identity', 'relu', 'leaky_relu', 'biased_relu', 'prelu', 'relu6'])

    # Layer 7
  # params_for_perf_key['layer7_kernel_size'] = trial.suggest_categorical('layer7_kernel_size', [3, 5])
    params_for_perf_key['layer7_act1'] = trial.suggest_categorical('layer7_act1', ['identity', 'tanh', 'telu', 'gelu', 'sigmoid', 'sinlu', 'elu', 'mish', 'silu'])
    params_for_perf_key['layer7_act2'] = trial.suggest_categorical('layer7_act2', ['identity', 'relu', 'leaky_relu', 'biased_relu', 'prelu', 'relu6'])
